...
async function GET(request) {
    try {
        ...
        const tenantId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTenantId"])(request);
        if (!tenantId) {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT id, tenant_id, email, role, created_at FROM users WHERE tenant_id = ? ORDER BY created_at DESC', [
            tenantId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52372a53._.js.map
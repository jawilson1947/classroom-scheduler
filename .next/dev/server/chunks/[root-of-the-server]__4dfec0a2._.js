    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                try {
                    const [users] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT * FROM users WHERE email = ?", [
                        credentials.email
                    ]);
                    if (users.length === 0) {
                        return null;
                    ...
                    const user = users[0];
                    const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, user.password_hash);
                    if (!isValid) {
                        return null;
                    }
                    return {
...
async function getTenantId(request) {
    ...
    // System admin can specify tenant via query params
    if (role === 'SYSTEM_ADMIN') {
        const url = new URL(request.url);
        const requestedTenantId = url.searchParams.get('tenant_id');
        return requestedTenantId ? parseInt(requestedTenantId) : tenantId;
    }
...
"[project]/src/app/api/tenants/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])();
        // Only super admins can list all tenants
        const isAdmin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSuperAdmin"])();
        if (!isAdmin) {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT * FROM tenants ORDER BY name');
...
async function POST(request) {
    try {
        ...
        const { name, slug, time_zone } = body;
        // Generate UUID
        const uuid = crypto.randomUUID();
        const [result] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('INSERT INTO tenants (uuid, name, slug, time_zone) VALUES (?, ?, ?, ?)', [
            uuid,
            name,
            slug,
            time_zone
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4dfec0a2._.js.map